...
import { BarChart3, Calculator, TrendingUp, ShieldCheck } from 'lucide-react';
    ...
    <div className="space-y-16 pb-16 bg-white">
      <section className="relative w-full overflow-hidden bg-white pt-16 lg:pt-24 pb-20 border-b text-center">
        <div className="container relative z-10 mx-auto px-4">
          <h1 className="mb-6 text-4xl font-black tracking-tight md:text-5xl lg:text-6xl text-center">
            <span className="text-gradient">Management #Accounts & Reporting</span>
          </h1>
